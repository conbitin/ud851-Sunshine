...
//      DONE (7) Replace the single TextView with Views to display all of the weather info
        ...
        int weahterIconId = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        ...
        forecastAdapterViewHolder.weatherIcon.setImageResource(weahterIconId);
        forecastAdapterViewHolder.weatherDate.setText(dateString);
        forecastAdapterViewHolder.weatherCondition.setText(description);
        forecastAdapterViewHolder.highTemp.setText(highTemperature);
        forecastAdapterViewHolder.lowTemp.setText(lowTemperature);
    }
...
//          DONE (6) Get references to all new views and delete this line
            weatherIcon = (ImageView) view.findViewById(R.id.iconWeather);
            weatherDate = (TextView) view.findViewById(R.id.textViewDate);
            weatherCondition = (TextView) view.findViewById(R.id.textViewCondition);
            highTemp = (TextView) view.findViewById(R.id.textViewHighTemp);
            lowTemp = (TextView) view.findViewById(R.id.textViewLowTemp);
