...
//  DONE (1) Create a constant int value to identify the notification
    private static final int SUNSHINE_NOTIFICATION_ID = 68;

    private static final String SUNSHINE_NOTIFICATION_CHANNEL_ID = "sunshine-channel";
...
//          DONE (3) Create an Intent with the proper URI to start the DetailActivity
            ...
            startDetailActivity.setData(todaysWeatherUri);

//          DONE (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(startDetailActivity);
